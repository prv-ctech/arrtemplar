...
describe("app settings layout", () => {
  ...
  it("uses real Services settings cards instead of placeholder copy", async () => {
    ...
    expect(source).toContain("/services/slskd.svg");
    expect(source).toContain('kind: "jackett"');
    expect(source).toContain('kind: "nzbhydra2"');
    expect(source).toContain('kind: "slskd"');
    expect(source).toContain('defaultPort: "5030"');
    expect(source).toContain('{ label: "No auth", value: "none" }');
    expect(source).not.toContain("/services/trawl.svg");
    expect(source).not.toContain('kind: "trawl"');
    expect(source).not.toContain("hideAuthModeSelector");
    ...
    expect(source).toContain('result.result.outcome !== "success"');
    expect(source).toContain("Connected");
    expect(source).toContain("Not configured");
    expect(source).toContain("useState(false)");
    expect(source).toContain('if (next.authMode === "none")');
