...
describe("notification event taxonomy", () => {
  it("classifies every migrated toast-producing action", () => {
    expect(TOAST_NOTIFICATION_EVENTS).toMatchObject({
      ...
      "api_keys.created": { importance: "important", severity: "success" },
      "api_keys.deleted": { importance: "important", severity: "success" },
      "api_keys.revoked": { importance: "important", severity: "success" },
      "api_keys.secret.copied": { importance: "standard", severity: "success" },
      "api_keys.updated": { importance: "important", severity: "success" },
      ...
      "services.add.failed": { importance: "important", severity: "error" },
      "services.added": { importance: "important", severity: "success" },
      "services.delete.failed": { importance: "important", severity: "error" },
      "services.deleted": { importance: "important", severity: "success" },
      "services.save.failed": { importance: "important", severity: "error" },
      "services.saved": { importance: "important", severity: "success" },
      "services.test.failed": { importance: "important", severity: "error" },
      "services.tested": { importance: "standard", severity: "success" },
