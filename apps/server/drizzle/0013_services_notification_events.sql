...
CREATE TABLE `__new_notification_history` (
	...
	`event_id` text NOT NULL CHECK (`event_id` IN ('auth.admin.created', 'auth.provider.save.failed', 'auth.provider.saved', 'auth.sign_out.failed', 'auth.signed_in', 'auth.signed_out', 'api_keys.create.failed', 'api_keys.created', 'api_keys.delete.failed', 'api_keys.deleted', 'api_keys.revoke.failed', 'api_keys.revoked', 'api_keys.secret.copy.failed', 'api_keys.secret.copied', 'api_keys.update.failed', 'api_keys.updated', 'managed_user.identity.failed', 'managed_user.identity.updated', 'managed_user.media.failed', 'managed_user.media.updated', 'managed_user.password.changed', 'managed_user.password.failed', 'managed_user.permissions.failed', 'managed_user.permissions.updated', 'profile.identity.update.failed', 'profile.identity.updated', 'profile.media.failed', 'profile.media.updated', 'profile.noop', 'profile.password.changed', 'profile.password.mismatch', 'profile.password.update.failed', 'services.add.failed', 'services.added', 'services.delete.failed', 'services.deleted', 'services.save.failed', 'services.saved', 'services.test.failed', 'services.tested', 'theme.changed', 'users.create.failed', 'users.created', 'users.password.changed', 'users.password.failed', 'users.permissions.failed', 'users.permissions.updated', 'users.status.disabled', 'users.status.failed', 'users.status.restored', 'users.deleted', 'users.delete.failed')),
	`title` text NOT NULL,
	`description` text,
